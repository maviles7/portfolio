...
function renderProjects() {
    if (projectContainer) {
        projects.forEach(project => {
            ...
            projectDeployLink.href = project.deployLink;
            projectDeployLink.innerText = "Explore Project";
            projectDeployLink.target = "_blank";
            projectDiv.appendChild(projectDeployLink);

            const projectGithubLink = document.createElement("a");
            projectGithubLink.href = project.githubLink;
            projectGithubLink.innerText = "Explore GitHub";
            projectGithubLink.target = "_blank";
            projectDiv.appendChild(projectGithubLink);
